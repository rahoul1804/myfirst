...
<!-- for pagination  -->
 ...
 <!--Paginatiton Code  -->
<a href="/jpaCrudProject/viewToController/${pre}">pre</a>  

<c:forEach begin="0" end="${cnt}" step="1" var="a" varStatus="loop" >
    
        <a href="/jpaCrudProject/viewToController/<c:out value="${loop.count}"/>" id="${loop.count}" onclick="colorChange('${loop.count}')"><c:out value="${loop.count}"/></a> 
    ...
    <a href="/jpaCrudProject/viewToController/${nxt}">next</a>  
